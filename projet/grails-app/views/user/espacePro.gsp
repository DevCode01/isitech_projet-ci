        ...
        <div class="user_card">
            ...
            <div class="d-flex justify-content-center form_container">
                <g:form action="login"  >
                    ...
                    <div class="input-group mb-3 center justify-content-center">
                        <button id="submit-values" class="btn btn-small btn-primary justify-content-center" type="submit">Login</button>
                    </div>
                    </g:form>
            </div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links">
                    Vous n'avez pas de compte ? <a href="../user/creationUser" class="ml-2">En créer un</a>
                </div>
            </div>
        </div>
    </div>
